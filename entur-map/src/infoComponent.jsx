...
const DestComp = (props) => {
    ...
    return (
        <div id='destination'>
            {(props.origin ?? "UNKOWN").toUpperCase()}&nbsp;&nbsp;&nbsp;&nbsp;➤&nbsp;&nbsp;&nbsp;&nbsp;{(props.destination ?? "UNKNOWN").toUpperCase()}
        </div>
    )
}
...
const InfoComponent = (props) => {
    ...
    return (
        <div ref={infoRef} className="onMapBox" style={{top: props.event.pixel[1] - 20 - infoHeight + 'px', left: props.event.pixel[0] - 200 + 'px'}}>
